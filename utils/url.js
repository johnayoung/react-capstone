...
const url = 'https://api.blockchain.info/charts/{chartName}{?timespan,rollingAverage,start,format,sampled}';
const tUrl = 'https://api.blockchain.info/charts/transactions-per-second?timespan=5weeks&rollingAverage=8hours&format=json';
...
const extractParamsFromUrl = (url, exampleUrl) => {
  ...
  return {varObj, filledUrl, decodedUrl, keys, serializeParams, exampleParams};
};
