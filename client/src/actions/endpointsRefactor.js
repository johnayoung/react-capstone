...
export const actionTypes = {
  FETCH_ENDPOINTS_REQUEST: 'FETCH_ENDPOINTS_REQUEST',
  FETCH_ENDPOINTS_SUCCESS: 'FETCH_ENDPOINTS_SUCCESS',
  FETCH_ENDPOINTS_ERROR: 'FETCH_ENDPOINTS_ERROR',
  SET_CURRENT_ENDPOINT_REQUEST: 'SET_CURRENT_ENDPOINT_REQUEST',
  SET_CURRENT_ENDPOINT_SUCCESS: 'SET_CURRENT_ENDPOINT_SUCCESS',
  CLEAR_CURRENT_ENDPOINT: 'CLEAR_CURRENT_ENDPOINT',
  FETCH_USER_REQUEST: 'FETCH_USER_REQUEST',
  FETCH_USER_SUCCESS: 'FETCH_USER_SUCCESS',
  FETCH_USER_ERROR: 'FETCH_USER_ERROR',
  SET_INITIAL_FORM_VALUES: 'SET_INITIAL_FORM_VALUES',
  POST_ENDPOINT_REQUEST: 'POST_ENDPOINT_REQUEST',
  POST_ENDPOINT_SUCCESS: 'POST_ENDPOINT_SUCCESS',
  POST_ENDPOINT_ERROR: 'POST_ENDPOINT_ERROR',
  USER_ENDPOINT_REQUEST: 'USER_ENDPOINT_REQUEST',
  USER_ENDPOINT_SUCCESS: 'USER_ENDPOINT_SUCCESS',
  USER_ENDPOINT_ERROR: 'USER_ENDPOINT_ERROR',
  USER_ENDPOINT_CLEAR: 'USER_ENDPOINT_CLEAR'
};
